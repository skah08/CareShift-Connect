...
INSERT INTO public.shift_templates (id, tenant_id, shift_code, start_time, end_time, is_night_shift, allocated_break_minutes) VALUES
  -- San Camillo
  ('e0000000-0000-4000-0000-000000000001', 'a0000000-0000-4000-0000-000000000001', 'M', '07:00', '14:00', false, 30),
  ('e0000000-0000-4000-0000-000000000002', 'a0000000-0000-4000-0000-000000000001', 'P', '14:00', '21:00', false, 30),
  ('e0000000-0000-4000-0000-000000000003', 'a0000000-0000-4000-0000-000000000001', 'N', '21:00', '07:00', true, 45),
  ('e0000000-0000-4000-0000-000000000004', 'a0000000-0000-4000-0000-000000000001', 'G', '08:00', '16:00', false, 30),
  ('e0000000-0000-4000-0000-000000000005', 'a0000000-0000-4000-0000-000000000001', 'TL', '07:00', '19:00', false, 60),
  ('e0000000-0000-4000-0000-000000000006', 'a0000000-0000-4000-0000-000000000001', 'TLN', '19:00', '07:00', true, 60),
  ('e0000000-0000-4000-0000-000000000007', 'a0000000-0000-4000-0000-000000000001', 'I', '10:00', '17:00', false, 30),
  -- Santa Maria Nuova
  ('e0000000-0000-4000-0000-000000000010', 'a0000000-0000-4000-0000-000000000002', 'M', '07:00', '14:00', false, 30),
  ('e0000000-0000-4000-0000-000000000011', 'a0000000-0000-4000-0000-000000000002', 'P', '14:00', '21:00', false, 30),
  ('e0000000-0000-4000-0000-000000000012', 'a0000000-0000-4000-0000-000000000002', 'N', '21:00', '07:00', true, 45),
  ('e0000000-0000-4000-0000-000000000013', 'a0000000-0000-4000-0000-000000000002', 'G', '08:00', '16:00', false, 30),
  ('e0000000-0000-4000-0000-000000000014', 'a0000000-0000-4000-0000-000000000002', 'TL', '07:00', '19:00', false, 60),
  ('e0000000-0000-4000-0000-000000000015', 'a0000000-0000-4000-0000-000000000002', 'TLN', '19:00', '07:00', true, 60),
  ('e0000000-0000-4000-0000-000000000016', 'a0000000-0000-4000-0000-000000000002', 'I', '10:00', '17:00', false, 30)
ON CONFLICT (id) DO NOTHING;
  ...
  FOR i IN 0..20 LOOP
    ...
    FOR j IN 1..4 LOOP
      ...
      start_str := CASE tpl_id
        WHEN 'e0000000-0000-4000-0000-000000000003' THEN '21:00:00'
        WHEN 'e0000000-0000-4000-0000-000000000004' THEN '08:00:00'
        WHEN 'e0000000-0000-4000-0000-000000000002' THEN '14:00:00'
        ELSE '07:00:00'
      END;
      end_str := CASE tpl_id
        WHEN 'e0000000-0000-4000-0000-000000000003' THEN '07:00:00'
        WHEN 'e0000000-0000-4000-0000-000000000004' THEN '16:00:00'
        WHEN 'e0000000-0000-4000-0000-000000000002' THEN '21:00:00'
        ELSE '14:00:00'
      END;
  ...
  FOR i IN 0..20 LOOP
    ...
    FOR j IN 1..4 LOOP
      ...
      VALUES (
        ...
        d,
        (CASE tpl_id
          WHEN 'e0000000-0000-4000-0000-000000000012' THEN (d::text || ' 21:00:00')::timestamp
          WHEN 'e0000000-0000-4000-0000-000000000013' THEN (d::text || ' 08:00:00')::timestamp
          WHEN 'e0000000-0000-4000-0000-000000000011' THEN (d::text || ' 14:00:00')::timestamp
          ELSE (d::text || ' 07:00:00')::timestamp
        END),
        (CASE tpl_id
          WHEN 'e0000000-0000-4000-0000-000000000012' THEN (d::text || ' 07:00:00')::timestamp + INTERVAL '1 day'
          WHEN 'e0000000-0000-4000-0000-000000000013' THEN (d::text || ' 16:00:00')::timestamp
          WHEN 'e0000000-0000-4000-0000-000000000011' THEN (d::text || ' 21:00:00')::timestamp
          ELSE (d::text || ' 14:00:00')::timestamp
        END),
        (CASE WHEN d <= today THEN 'Completed' ELSE 'Scheduled' END)::assignment_status,
        'Regular_Shift'::coverage_type
      )
